  ...
  <div class="ui middle aligned stackable grid container">
    <div class="row">
      <div class="column">
        ...
        <div class="ui menu">
          <a href="?filter=month" class="<?= (($filter == 'month' || $filter == '') ? 'active' : '') ?> item">30 Days</a>
        ...
        <table class="ui attached table">
          ...
          <tbody>
            <?php foreach ($powerups as $powerup) { ?>
            <tr>
              ...
              <td class="collapsing right aligned">
                <?= $this->partial('_elements/vesting_shares', ['current' => $powerup->account[0]]) ?>
              </td>
              <td>
                <div class="ui header">
                  ...
                  <?= $this->tag->linkTo(['/@' . $powerup->account[0]->name, $powerup->account[0]->name]) ?>
                </div>
              </td>
            </tr>
            <?php } ?>
