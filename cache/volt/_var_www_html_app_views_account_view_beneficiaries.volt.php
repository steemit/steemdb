<div class="ui three item inverted menu">
  <a href="/@<?= $account->name ?>/authoring" class="<?= ($this->router->getActionName() == 'authoring' ? 'active' : '') ?> blue item">Author Rewards</a>
  <a href="/@<?= $account->name ?>/curation" class="<?= ($this->router->getActionName() == 'curation' ? 'active' : '') ?> blue item">Curation Rewards</a>
  <a href="/@<?= $account->name ?>/beneficiaries" class="<?= ($this->router->getActionName() == 'beneficiaries' ? 'active' : '') ?> blue item">Beneficiary Rewards</a>
</div>
...
<table class="ui striped sortable table">
  ...
  <tbody>
    <?php $v121104352188310891071iterated = false; ?><?php foreach ($beneficiaries as $reward) { ?><?php $v121104352188310891071iterated = true; ?>
        <tr>
    ...
    <?php } if (!$v121104352188310891071iterated) { ?>
        <tr>
          <td colspan="10">
            <div class="ui header">
