    ...
    <div class="row">
      <div class="column">
        <div class="ui huge header">
          Posts from <?= strip_tags(date('Y-m-d', $date)) ?>
          <div class="sub header">
            ...
            <span class='ui icon label'>
              <?= $tag ?>
              <a href="/posts/all/<?= ($sort ? $sort : 'earnings') ?>/<?= strip_tags(date('Y-m-d', $date)) ?>">
                <i class="close icon" style="margin-right: 0"></i>
              </a>
            </span>
            <?php } ?>
            posts created on <?= strip_tags(date('Y-m-d', $date)) ?>.
          </div>
        </div>
        <input type="hidden" id="selectedDate" value="<?= strip_tags(date('Y-m-d', $date)) ?>">
        ...
        <div class="ui menu">
          ...
          <div class="ui dropdown item">
            ...
            <div class="menu">
              <a href="/posts/<?= ($tag ? $tag : 'all') ?>/earnings/<?= strip_tags(date('Y-m-d', $date)) ?>" class="item">
                Top Earning
              </a>
              <a href="/posts/<?= ($tag ? $tag : 'all') ?>/votes/<?= strip_tags(date('Y-m-d', $date)) ?>" class="item">
                Most Votes
              </a>
            </div>
          </div>
