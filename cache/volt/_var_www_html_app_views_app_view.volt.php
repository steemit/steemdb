    ...
    <div class="row">
      <div class="twelve wide column" id="main-context">
        <div class="ui top attached menu">
          <?= $this->tag->linkTo([['for' => 'app-view', 'app' => $app], '<i class=\'home icon\'></i>', 'class' => 'icon item' . (($this->router->getActionName() == 'view' ? ' active' : ''))]) ?>
          <?= $this->tag->linkTo([['for' => 'app-view-section', 'app' => $app, 'action' => 'earnings'], 'Earnings', 'class' => 'item' . (($this->router->getActionName() == 'earnings' ? ' active' : ''))]) ?>
        </div>
        <div class="ui bottom attached secondary segment">
          <?php $this->partial('app/view/' . $this->router->getActionName()); ?>
        </div>
      </div>
