...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      {/* Full-width row (not a centered container): the brand aligns with the
          sidebar content below (px-4) and the right actions stay pinned to
          the viewport edge at any width. */}
